...
public interface InfoService {
    ...
    //存储新发布的公告
    void insertgginfo(@Param("info") String content);
    //查询员工信息
    List<Manager> getmanagerinfo();
    //layui数据表格数据格式拼接
    Map<Object,Object> getdata();
    //插入新员工信息
    void insertmanagerinfo(@Param("number") String anumber, @Param("name") String bname, @Param("part") String cpart, @Param("sex") String dsex, @Param("province") String eprovince, @Param("city") String fcity, @Param("telephone") String gtelephone, @Param("personnumber") String hpersonnumber);
    //删除员工
